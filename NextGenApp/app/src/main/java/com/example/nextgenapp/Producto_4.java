...
public class Producto_4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_producto_4);
        ImageSlider imageSlider = findViewById(R.id.imageSlider);
        ArrayList<SlideModel> slideModels = new ArrayList<>();

        slideModels.add(new SlideModel(R.drawable.promouse, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.promouse_1, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.promouse_2, ScaleTypes.FIT));
