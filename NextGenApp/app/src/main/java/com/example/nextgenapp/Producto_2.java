...
public class Producto_2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_producto_2);
        ImageSlider imageSlider = findViewById(R.id.imageSlider);
        ArrayList<SlideModel> slideModels = new ArrayList<>();

        slideModels.add(new SlideModel(R.drawable.msi4080, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.msi4080_1, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.msi4080_2, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.msi4080_3, ScaleTypes.FIT));
